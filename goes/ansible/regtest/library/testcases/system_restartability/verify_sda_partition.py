...
DOCUMENTATION = """
---
module: verify sda partition
author: Platina Systems
short_description: Module to verify SDA partition.
description:
    Module to verify SDA partition and log the same.
options:
    switch_name:
      description:
...
def verify_sda_partition(module):
